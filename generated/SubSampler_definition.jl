...
# Component SubSampler is an external component definition.  This means that the
...
# The implementation of the function (function SubSampler(; name, params...))
# must be manually written.
function SubSampler end
export SubSampler
