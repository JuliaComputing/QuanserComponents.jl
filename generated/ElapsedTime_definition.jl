...
| ------------ | ----------------------------------- | ------ | --------------- |
| `Ts`         | Sample time (defaults to SampleTime())                         | --  |   SampleTime() |
...
@component function ElapsedTime(; name = nothing, Ts=SampleTime(), kwargs...)
  ...
  push!(__initialization_eqs, y(ShiftIndex() -1) ~ 0)
